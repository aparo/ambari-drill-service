...
class Master(Script):
  def install(self, env):
    ...
    if not os.path.exists(params.drill_temp_file):
      Execute('wget http://ftp.unicamp.br/pub/apache/drill/drill-1.13.0/apache-drill-1.13.0.tar.gz -O ' + params.drill_temp_file + ' -a ' + params.drill_log_file, user=params.drill_user)
